...
"${CC:-cc}" -std=c11 -D_GNU_SOURCE -Wall -Wextra -Werror -Wno-unused-parameter -Iservices/zettide \
	services/zettide/spdk/runtime.c services/zettide/spdk/bdev_endpoint.c services/zettide/spdk/bdev_dispatcher.c \
	services/zettide/spdk/bdev_provider.c tests/spdk_provider.c \
