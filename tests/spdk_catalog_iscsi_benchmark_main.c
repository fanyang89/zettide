...
int zettide_spdk_catalog_iscsi_benchmark(const char *ready_path,
		const char *member_path, int mode, const char *expected_pool_id);
...
main(int argc, char **argv)
{
	...
	return zettide_spdk_catalog_iscsi_benchmark(
			argv[1], argv[2], mode, expected_pool_id);
}
