...
"${CC:-cc}" -std=c11 -D_GNU_SOURCE -Wall -Wextra -Werror -Wno-unused-parameter -Iservices/zettide -Itest \
	services/zettide/spdk/runtime.c services/zettide/spdk/bdev_provider.c services/zettide/spdk/nvmf_tcp_export.c tests/spdk_runtime.c \
...
# shellcheck disable=SC2046
"${CC:-cc}" -std=c11 -D_GNU_SOURCE -Wall -Wextra -Werror -Wno-unused-parameter -Iservices/zettide -Itest \
	services/zettide/spdk/runtime.c tests/spdk_runtime.c tests/spdk_nvmf_target.c \
...
"${CC:-cc}" -std=c11 -D_GNU_SOURCE -Wall -Wextra -Werror -Wno-unused-parameter -Iservices/zettide -Itest \
	...
	services/zettide/spdk/runtime.c services/zettide/spdk/nvme_controller.c services/zettide/spdk/bdev_endpoint.c \
	services/zettide/spdk/bdev_dispatcher.c tests/spdk_runtime.c \
