...
"${CC:-cc}" -std=c11 -D_GNU_SOURCE -Wall -Wextra -Werror -Wno-unused-parameter -Iservices/zettide \
	services/zettide/spdk/runtime.c services/zettide/spdk/vhost_blk_controller.c tests/spdk_vhost_blk_controller.c \
...
# shellcheck disable=SC2046
"${CC:-cc}" -std=c11 -D_GNU_SOURCE -Wall -Wextra -Werror -Wno-unused-parameter -Iservices/zettide \
	services/zettide/spdk/runtime.c services/zettide/spdk/bdev_provider.c services/zettide/spdk/nvmf_tcp_export.c \
