...
pub fn parseEx(
    ...
    const argument_info = @typeInfo(@TypeOf(arguments)).@"struct";
    inline for (argument_info.field_names, argument_info.field_types) |field_name, FieldType| {
