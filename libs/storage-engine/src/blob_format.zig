...
pub const blob_size: u32 = data_mode_geometry.blob.chunk_size;
...
pub const minimum_device_size: u64 = data_mode_geometry.blob.minimum_device_size;

comptime {
    std.debug.assert(minimum_device_size == arena_offset + blob_size);
}
