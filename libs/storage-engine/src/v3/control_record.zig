...
fn readFixture(comptime size: usize, comptime path: []const u8) ![size]u8 {
    const fixture_text = @embedFile(path);
...
test "record golden fixture and fingerprint" {
    ...
    const fixture = try readFixture(encoded_size, "../testdata/v3/control-record.hex");
...
test "certificate exact offsets canonical ordering round trip and fixture" {
    ...
    const fixture = try readFixture(certificate_size, "../testdata/v3/commit-certificate.hex");
