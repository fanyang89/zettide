...
test "record golden fixture and fingerprint" {
    ...
    const fixture = try readFixture(encoded_size, "tests/fixtures/v3/control-record.hex");
...
test "certificate exact offsets canonical ordering round trip and fixture" {
    ...
    const fixture = try readFixture(certificate_size, "tests/fixtures/v3/commit-certificate.hex");
