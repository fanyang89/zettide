...
pub const data_node_pb = @import("data_node_proto");
...
pub const data_service = data_service_contracts.replica_service;
...
pub const data_service_rpc_client = @import("data_service_rpc_client.zig");
