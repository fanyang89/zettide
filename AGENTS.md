...
components live in `libs/storage-engine/`, `services/data-node/`, `services/controller/`,
...
from the repository root use `zig build test-storage-engine`, `test-data-node`,
