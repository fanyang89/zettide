...
| --- | --- | --- |
| [0001](0001-storage-node-naming-and-process-model.md) | Accepted | Defines the implemented storage library/node naming split and the remaining daemon composition boundary |
